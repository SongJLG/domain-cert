    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.CharField(blank=True, choices=[('manager', '管理人员'), ('staff', '普通员工')], max_length=50, null=True, verbose_name='职位')),
            ],
            options={
                'verbose_name': '账户管理',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='children', to='account.Structure', verbose_name='上级业务')),
            ],
            options={
                'verbose_name': '账户管理',
        ...
        migrations.AddField(
            model_name='user',
            name='department',
            field=models.ManyToManyField(blank=True, to='account.Structure', verbose_name='部门'),
        ),
        migrations.AddField(
            model_name='user',
            name='groups',
